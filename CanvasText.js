...
var CanvasText = {
  ...
  renderTextToFit: function(context, object) {
  ...
  getFitFont: function(context, object) {
  ...
  resolveFontFamily: function(object) {
    if (object.font) {
  ...
  canvasFontHeightForText: function(context, object, text) {
    var offset = 10;
    var fontSize = parseInt(CanvasText.resolveFont(object));
  ...
  createPrivateProperty: function(object, property, value) {
